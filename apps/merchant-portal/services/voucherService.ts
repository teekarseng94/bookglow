/**
 * Voucher Service — dual provider (Firestore / Supabase Phase 4).
 */
import {
  addDoc,
  collection,
...
export const voucherService = useSupabase()
  ? supabaseMerchant.voucherService
  : firestoreVoucherService;
