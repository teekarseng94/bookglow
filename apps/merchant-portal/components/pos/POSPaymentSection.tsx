      ...
      {useCustomDateTime ? (
        <div className="flex gap-2">
          <input
            ...
            className="m-pos-control flex-1 min-h-[40px] py-2 px-2.5 bg-[var(--bg-surface)] border border-[var(--line)] rounded-ui-md text-sm outline-none focus-visible:shadow-ui-focus-strong box-border"
          />
          <input
            type="time"
            value={customTime}
            onChange={(e) => onCustomTimeChange(e.target.value)}
            className="m-pos-control w-28 min-h-[40px] py-2 px-2.5 bg-[var(--bg-surface)] border border-[var(--line)] rounded-ui-md text-sm outline-none focus-visible:shadow-ui-focus-strong box-border"
          />
        </div>
      ) : (
